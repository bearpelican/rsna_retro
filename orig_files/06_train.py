...
learn.dbunch = get_data(128, 192, use_wgt=True)
do_fit(learn, 2, lr     * 2, freeze=False, **no_1cycle)
learn.dbunch = get_data(128, 352, use_wgt=True)
do_fit(learn, 2, lr*2/3 * 2, freeze=False, **no_1cycle)
learn.dbunch = get_data(64,  512, use_wgt=True)
do_fit(learn, 1, lr*2/3*2/3, freeze=False, **no_1cycle)

learn.loss_func = get_loss()
learn.dbunch = get_data(64, None, use_wgt=False)
do_fit(learn, 1, lr*2/3*2/3, freeze=False, **no_1cycle)
