#AUTOGENERATED! DO NOT EDIT! File to edit: dev/02_train_00_train.ipynb (unless otherwise specified).

__all__ = ['get_pil_fn', 'fn2label', 'mean', 'std', 'get_wgts', 'get_data_gen', 'filename', 'get_data', 'accuracy_any',
           'get_loss', 'get_learner', 'do_fit', 'get_test_data', 'submission']
...
#Cell
def get_test_data(df_tst, bs=512, sz=224, tst_dir='tst_jpg', tst_splits=tst_splits):
